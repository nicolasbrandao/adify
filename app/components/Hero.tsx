      ...
      <div className="flex flex-col w-full gap-8 p-4">
        ...
        <div className='mt-4'>
          <div className='flex flex-col justify-between gap-4'>
            <a href="#" className='btn btn-lg bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-base-300'>Contato</a>
            <a href="#" className='btn btn-lg btn-primary btn-outline'>Artigos</a>
          </div>
        </div>
      </div>
    </section>

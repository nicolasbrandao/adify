...
export default function ProductDetails() {
  return (
    <section className="flex flex-col gap-4 my-auto p-4">
      <div className="flex flex-col lg:flex-row gap-4">
        <div className="flex flex-col gap-4 lg:max-w-[380px] mt-12">
          <h1 className="font-bold text-[2rem] bg-gradient-to-r from-cyan-300 to-gray-200 text-transparent bg-clip-text">
            Título do Produto
          </h1>
        ...
        <div className="mockup-window bg-base-100 lg:w-fit h-fit my-auto">
          <Image
